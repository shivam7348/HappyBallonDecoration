...
function About() {
  return (
    <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8 bg-gray-50">
      {/* Heading */}
      <h3 className="text-3xl sm:text-4xl font-bold text-center text-red-400 mb-6">
        About Us
      </h3>
      ...
      <div className="max-w-7xl mx-auto">
        {/* Description */}
        <p className="text-lg sm:text-xl text-gray-800 text-center mb-8 sm:mb-12 px-4">
